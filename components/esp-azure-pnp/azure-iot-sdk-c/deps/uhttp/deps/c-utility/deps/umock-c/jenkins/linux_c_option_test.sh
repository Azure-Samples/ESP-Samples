...
build_folder=$build_root"/cmake/cmake_options"
...
declare -a arr=(
    "-Drun_unittests=OFF -Drun_int_tests=OFF -Duse_cppunittest=OFF"
    "-Drun_unittests=OFF -Drun_int_tests=ON -Duse_cppunittest=OFF"
    "-Drun_unittests=ON -Drun_int_tests=OFF -Duse_cppunittest=OFF"
    "-Drun_unittests=ON -Drun_int_tests=ON -Duse_cppunittest=OFF"
    "-Drun_unittests=OFF -Drun_int_tests=OFF -Duse_cppunittest=ON"
    "-Drun_unittests=OFF -Drun_int_tests=ON -Duse_cppunittest=ON"
    "-Drun_unittests=ON -Drun_int_tests=OFF -Duse_cppunittest=ON"
    "-Drun_unittests=ON -Drun_int_tests=ON -Duse_cppunittest=ON"
)
